...
BPredUnit::BPredUnit(const Params *params) : SimObject(params),BTB(params->BTBEntries,params->BTBTagSize,params->InstShiftAmt)
{
...
BPredUnit::regStats()
{
    ...
    RASIncorrect
     ...
     UpdatePredictor
       .name(name() + ".UpdatePredictor")
       .desc("Number of times the predictor counter is updated.")
       ;

    correctpredictionPercent
       .name(name() + ".correctpredictionPercent")
                   ...
                   TheISA::PCState &pc, ThreadID tid)
{
 ...
 // fl1.log(msg1);
    ...
    if (inst->isUncondCtrl()) {
        ...
        uncondBranch(bp_history,pc.instAddr());
    } else {
        ++condPredicted;
 ...
 //  fl1.log(msg1);
   // added by me
    ...
    if (inst->isUncondCtrl()) {
        ...
        pred_taken = true;
        // Tell the BP there was an unconditional branch.
        uncondBranch(bp_history,predPC.instAddr());
   ...
   //sprintf (msg1, "predict inorder called \n");
   // fl1.log(msg1);
